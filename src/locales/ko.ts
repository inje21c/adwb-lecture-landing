const ko = {
    ...
    areas: [
      {
        ...
        description: "모호한 기획안이 고객 관점의 명확한 '가치 제안'으로 강제 변환됩니다.",
        steps: [
          { num: 1, name: "보도자료 작성", purpose: "고객가치 정의", tool: "ChatGPT · Claude · Gemini" },
          { num: 2, name: "KPI 역산", purpose: "성공 기준 수치화", tool: "AI 대화형 구체화" },
        ],
      },
      {
        key: "34",
        ...
        description: "기획자도 디자이너도 없이, 현업 담당자가 단 하루 만에 '작동하는 목업'을 직접 생성합니다.",
        steps: [
          { num: 3, name: "프롬프트 설계", purpose: "시각화 설계도 확보", tool: "레퍼런스 조합 (역설계)" },
          { num: 4, name: "목업 제작", purpose: "화면 가시화", tool: "Lovable · Stitch · Figma" },
        ],
      },
      {
        key: "56",
        phaseRange: "Phase 5 & 6",
        label: "설계 및 RFP 자동 생성",
        subtitle: "Automated Blueprinting",
        description: "추상적인 텍스트가 아닌, 실제 동작하는 화면을 기반으로 과업 범위를 선정하여 해석 오차를 제로(0)로 만듭니다.",
        steps: [
          { num: 5, name: "설계서 생성", purpose: "최종 구조 문서화", tool: "Codex · Claude Code" },
          { num: 6, name: "RFP 작성", purpose: "발주 준비", tool: "AI 문서 자동화" },
        ],
      },
    ],
  },
  ...
  comparison: {
    ...
    rows: [
      { label: "요구사항 도출 방식", before: "현업→기획자→IT (3단계, 의미 왜곡)", after: "보도자료로 강제 선명화 → 현업이 목업을 직접 체험·확인" },
      { label: "1차 산출물 도달", before: "4~8주", after: "3~4일 (6단계 파이프라인)" },
      { label: "요구사항 정제", before: "문서 검토 회의 (추상적)", after: "목업 체험→피드백→수정 반복 (구체적)" },
      { label: "RFP 형태", before: "텍스트 중심, 해석 여지 다분", after: "작동 목업 + 화면 설계서 + RFP 초안" },
      { label: "견적 편차", before: "업체 간 2배 이상 차이", after: "설계서 기반 범위 명확, 해석 오차 최소화" },
      { label: "개발 후 CR", before: "빈번 (\"원했던 게 아닌데\")", after: "최소화 (목업으로 사전 합의)" },
      { label: "도입 비용", before: "기획 컨설팅 수천만원", after: "AI 도구 구독 + 내부 인력 (수만원대)" },
    ],
  },
  ...
  cta: {
    tag: "관심 있으신가요?",
    headline: "방법론을 같이 이야기해보고 싶습니다.",
    subtext: "워크숍 커리큘럼을 준비 중입니다. 관심 있으신 분들의 피드백이 방향을 잡는 데 큰 도움이 됩니다.",
    cards: [
      { title: "팀 도입 논의", desc: "조직의 IT 조달이나 요구사항 정의에 어려움을 겪고 계신가요? 구체적인 상황을 함께 검토해 드립니다." },
      { title: "워크숍 사전 관심 등록", desc: "1일 집중 세션을 준비 중입니다. 관심을 남겨주시면 오픈 시 가장 먼저 안내드리겠습니다." },
      { title: "이런 분들과 이야기 나누고 싶습니다", desc: "기획자/PM · 개발자 · 영업/사업개발 · IT 조달 담당자 — 요구사항 왜곡을 직접 경험해보신 분이라면 누구든 환영합니다." },
    ],
    button: "연결하기",
    contactNote: "LinkedIn DM 또는 아래 폼으로 문의해 주세요.",
  },
